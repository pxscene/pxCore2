...
cmake -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DENABLE_DEBUG_METRICS=ON .. >>$BUILDLOGS 2>&1;
...
cmake -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DENABLE_DEBUG_METRICS=ON .. 1>>$BUILDLOGS;
