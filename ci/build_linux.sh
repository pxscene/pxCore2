...
cmake --build src/ --clean-first >>$BUILDLOGS 2>&1;
...
cmake --build examples/pxScene2d/src/ --clean-first >>$BUILDLOGS 2>&1;
...
cmake --build tests/pxScene2d/ --clean-first >>$BUILDLOGS 2>&1;
...
cmake --build src/ --clean-first 1>>$BUILDLOGS;
...
cmake --build examples/pxScene2d/src/ --clean-first 1>>$BUILDLOGS;
...
cmake --build tests/pxScene2d/ --clean-first 1>>$BUILDLOGS;
