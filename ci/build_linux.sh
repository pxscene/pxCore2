...
then
	...
	cmake -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DBUILD_DEBUG_METRICS=ON -DPXSCENE_TEST_HTTP_CACHE=ON -DSPARK_ENABLE_VIDEO=ON .. >>$BUILDLOGS 2>&1;
  ...
  cmake -DBUILD_PX_TESTS=ON -DBUILD_PXSCENE_STATIC_LIB=ON -DBUILD_DEBUG_METRICS=ON -DPXSCENE_TEST_HTTP_CACHE=ON -DSPARK_ENABLE_VIDEO=ON .. 1>>$BUILDLOGS;
