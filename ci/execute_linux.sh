...
cd $TRAVIS_BUILD_DIR/examples/pxScene2d/src
mv sparkpermissions.conf sparkpermissions.conf_orig
cp $TRAVIS_BUILD_DIR/ci/supportfiles/sparkpermissions.conf .
cp $TRAVIS_BUILD_DIR/ci/supportfiles/.sparkSettings.json ~/.
...
mv sparkpermissions.conf_orig sparkpermissions.conf
rm ~/.sparkSettings.json
