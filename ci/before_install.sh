...
then 
  ...
  travis_retry sudo apt-get install git libglew-dev freeglut3 freeglut3-dev zlib1g-dev g++ nasm autoconf valgrind libyaml-dev lcov cmake gdb quilt libuv-dev xmlto
fi
...
SRC_REPO_USER_NAME='kannanmadanagopalt'
