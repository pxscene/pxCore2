...
// Key Codes
#define PX_KEY_NATIVE_ENTER        DIKS_RETURN  // **
...
#define PX_KEY_NATIVE_EQUALS       DIKI_EQUAL
...
#define PX_KEY_NATIVE_MULTIPLY     DIKI_KP_MULTIPLY
#define PX_KEY_NATIVE_ADD          DIKI_KP_ADD
#define PX_KEY_NATIVE_SEPARATOR    DIKI_MINUS
#define PX_KEY_NATIVE_SUBTRACT     DIKI_KP_MINUS
#define PX_KEY_NATIVE_DECIMAL      DIKI_KP_DECIMAL
#define PX_KEY_NATIVE_DIVIDE       DIKI_KP_DIVIDE
...
#define PX_KEY_NATIVE_HELP         DIKI_HELP
