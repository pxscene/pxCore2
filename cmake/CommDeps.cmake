option(SPARK_ENABLE_VIDEO "SPARK_ENABLE_VIDEO" OFF)
option(SPARK_ENABLE_VIDEO_PUNCHTHROUGH "SPARK_ENABLE_VIDEO_PUNCHTHROUGH" OFF)
...
if (NOT WIN32)
	...
	if (SPARK_ENABLE_VIDEO)
		set( ENV{PKG_CONFIG_PATH} "$ENV{PKG_CONFIG_PATH}:${EXTDIR}/extlibs/lib/pkgconfig" )
		pkg_check_modules(GSTREAMER REQUIRED gstreamer-1.0)
		pkg_check_modules(GSTREAMERBASE REQUIRED gstreamer-app-1.0)
		if (NOT SPARK_ENABLE_VIDEO_PUNCHTHROUGH)
			pkg_check_modules(GSTREAMERGL REQUIRED gstreamer-gl-1.0)
		endif (NOT SPARK_ENABLE_VIDEO_PUNCHTHROUGH)

		include_directories(${GSTREAMER_INCLUDE_DIRS})
		include_directories(${GSTREAMERBASE_INCLUDE_DIRS})
		include_directories(${GSTREAMERGL_INCLUDE_DIRS})
		set(COMM_DEPS_LIBRARY_DIRS ${GSTREAMER_LIBRARY_DIRS} ${GSTREAMERBASE_LIBRARY_DIRS} ${GSTREAMERGL_LIBRARY_DIRS} ${COMM_DEPS_LIBRARY_DIRS})
		set(COMM_DEPS_LIBRARIES ${PXSCENE_LINK_LIBRARIES} aamp abr dash xml2 uuid ${GSTREAMERGL_LIBRARIES} ${GSTREAMERBASE_LIBRARIES} ${COMM_DEPS_LIBRARIES} )
