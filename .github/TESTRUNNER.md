...
1. Create a test JavaScript file according to instructions in [Defining Tests](#defining-test-functions-to-be-run). We suggest creating a pull request to add the test to [pxscene](https://github.com/pxscene/Spark/tree/master) for open source availability. Travis CI tests are located at https://github.com/pxscene/Spark/tree/master/tests-ci/tests.
...
{"url":"https://www.sparkui.org/examples/gallery/gallery.js", "title":"coverflow", "useBaseURI":"false", "timelimit":"60000"}
...
``` 
./pxscene.sh https://www.sparkui.org/tests-ci/test-run/testRunner.js
```
...
``` 
./pxscene.sh {local_path_to_sparkui}/tests-ci/test-run/testRunner.js
```
...
``` 
./pxscene.sh https://www.sparkui.org/tests-ci/test-run/testRunner.js?tests=file://{local_path_to_a_tests.json_file}
```
