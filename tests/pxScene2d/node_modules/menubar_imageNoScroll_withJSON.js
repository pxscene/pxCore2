...
var globals = require("globals");
	...
	MenuBarImageNoScroll.prototype.animateBlur = function(image) {
	...
	MenuBarImageNoScroll.prototype.animateFocus = function(image, lineTopFocus, lineBtmFocus) {
...
function MenuBarImageNoScroll(parentScene, x, y, w, h, imageItems, picWidth, picHeight) {
	...
	this.picPad = 5;
	this.picY = 50; // relative to container position
	...
	this.container.on('onFocus', function(e) {
		console.log("onFocus received in  noScroll");
		...
		this.lineTopFocus.ready.then(function(img) {
			//img.w = w;
			//img.x = x;
			//img.y = y-4;
			img.h = 4;
		...
		this.lineBtmFocus.ready.then(function(img) {
			//img.w = w;
			//img.x = x;
			//img.y = y+h;
			img.h = 4;
	...
	this.container.on('onBlur', function(e) {
		console.log("onBlur received in  noScroll");
		var image = this.imageObjs[this.focusIndx];
	...
	this.container.on('onKeyDown', function(e) {
	  if (e.keyCode == 40) { // down arrow
		 console.log("onKeyDown 40 (down arrow) received in menubar_image this.container for noScroll");

	  } 
	  else if(e.keyCode == 38) { // up arrow
		  console.log("onKeyDown 38 (up arrow) received in menubar_image_4 this.container for  noScroll");
	  } 
	  // Handle left/right keys for navigation
	  else if( e.keyCode == 39 || e.keyCode == 37) {
		  if(e.keyCode == 39) { // right arrow
			  console.log("onKeyDown 39 (right arrow) received in menubar_image_4 this.container for  noScroll");
			  ...
			  if( this.focusIndx < (this.imageObjs.length-1)) {
				  ...
				  console.log("imageBarNoScroll is propagating arrow key");
			  }
			  
			 
		  } else if(e.keyCode == 37) { // left arrow
			  console.log("onKeyDown 37 (left arrow) received in menubar_image_4 this.container for  noScroll");
	...
	scene.root.on('onKeyDown', function(e) {
	  if (e.keyCode == 40) { // down arrow
		 console.log("onKeyDown 40 (down arrow) received in menuBarImage scene  noScroll");
		
	  } else if(e.keyCode == 38) { // up arrow
		  console.log("onKeyDown 38 (up arrow) received in menuBarImage scene  noScroll");
		 

	  } else if(e.keyCode == 39) { // right arrow
		  console.log("onKeyDown 39 (right arrow) received in menuBarImage scene  noScroll");

	  } else if(e.keyCode == 37) { // left arrow
		  console.log("onKeyDown 37 (left arrow) received in menuBarImage scene  noScroll");
 ...
 */
MenuBarImageNoScroll.prototype.setMenuItems = function(newImageUrls) {
 ...
 */
MenuBarImageNoScroll.prototype.showMenu = function() {
	...
	for( var i = 0; i < this.imageUrls.length; i++) {
	    ...
	    picture = scene.createImage({url:url, parent:this.imageContainer, x:this.xPos, a:1, y:this.picY});
 ...
 * scrollRight
 */
MenuBarImageNoScroll.prototype.scrollRight = function()  {
 ...
 * scrollLeft
 */
MenuBarImageNoScroll.prototype.scrollLeft = function() {
...
module.exports = MenuBarImageNoScroll;
