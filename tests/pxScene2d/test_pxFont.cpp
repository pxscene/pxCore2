...
TEST(pxFontTest, testAddFont)
{
  ...
  rtRef<pxFont> font1 = pxFontManager::getFont("http://www.sparkui.org/examples/fonts/DejaVuSans.ttf");
  font1Id = ((pxFont*)font1.getPtr())->getFontId();

  rtRef<pxFont> font2 = pxFontManager::getFont("http://www.sparkui.org/examples/fonts/IndieFlower.ttf");
  font2Id = ((pxFont*)font2.getPtr())->getFontId();

  EXPECT_NE(font1Id, font2Id);

  rtRef<pxFont> font3 = pxFontManager::getFont("http://www.sparkui.org/examples/fonts/DejaVuSans.ttf");
...
TEST(pxFontTest, testRemoveFont)
{
  ...
  rtRef<pxFont> font4 = pxFontManager::getFont("http://www.sparkui.org/examples/fonts/DejaVuSans.ttf");
