...
class StageUtils$1 {
    ...
    static getTimingFunction(str) {
        switch (str) {
            ...
            case "ease":
                return StageUtils$1.getTimingBezier(0.25, 0.1, 0.25, 1.0);
            case "ease-in":
                return StageUtils$1.getTimingBezier(0.42, 0, 1.0, 1.0);
            case "ease-out":
                return StageUtils$1.getTimingBezier(0, 0, 0.58, 1.0);
            case "ease-in-out":
                return StageUtils$1.getTimingBezier(0.42, 0, 0.58, 1.0);
            case "step-start":
                return function () {
                    return 1
                };
            ...
            default:
                ...
                if (str && str.indexOf(s) === 0) {
                    ...
                    return StageUtils$1.getTimingBezier(a, b, c, d);
                } else {
                    console.warn("Unknown timing function: " + str);
                    // Fallback: use linear.
                    return function (time) {
...
Utils$1.isNode = (typeof window === "undefined");
Utils$1.isWeb = (typeof window !== "undefined");
...
class TextureSource {
    ...
    _isNativeTexture(source) {
        return ((Utils$1.isNode ? source.constructor.name === "WebGLTexture" : source instanceof WebGLTexture));
    }
...
class Element {
    ...
    static getMerger(property) {
        if (Element.isColorProperty(property)) {
            return StageUtils$1.mergeColors;
        } else {
            return StageUtils$1.mergeNumbers;
        }
    }
}
...
class WebGLRenderer extends Renderer {
    ...
    addQuad(renderState, quads, index) {
        ...
        const mca = StageUtils$1.mergeColorAlpha;
...
class C2dCoreRenderExecutor extends CoreRenderExecutor {
    ...
    _clearRenderTexture() {
        ...
        if (!clearColor[0] && !clearColor[1] && !clearColor[2] && !clearColor[3]) {
            ...
            ctx.fillStyle = StageUtils$1.getRgbaStringFromArray(clearColor);
...
class DefaultShader$1 extends C2dShader {
            ...
            if (rect) {
                ...
                if (colorize) {
                    ...
                    if (vc._colorUl !== vc._colorUr || vc._colorUr !== vc._colorBl || vc._colorBr !== vc._colorBl) {
                        color = StageUtils$1.mergeMultiColorsEqual([vc._colorUl, vc._colorUr, vc._colorBl, vc._colorBr]);
                    }
    ...
    _setColorGradient(ctx, vc, w = vc.w, h = vc.h, transparency = true) {
        ...
        if (vc._colorUl === vc._colorUr) {
            if (vc._colorBl === vc._colorBr) {
                if (vc._colorUl === vc.colorBl) ; else {
                    ...
                    if (transparency) {
                        gradient.addColorStop(0, StageUtils$1.getRgbaString(vc._colorUl));
                        gradient.addColorStop(1, StageUtils$1.getRgbaString(vc._colorBl));
                    } else {
                        gradient.addColorStop(0, StageUtils$1.getRgbString(vc._colorUl));
                        gradient.addColorStop(1, StageUtils$1.getRgbString(vc._colorBl));
            ...
            if (vc._colorUl === vc._colorBl && vc._colorUr === vc._colorBr) {
                ...
                if (transparency) {
                    gradient.addColorStop(0, StageUtils$1.getRgbaString(vc._colorUl));
                    gradient.addColorStop(1, StageUtils$1.getRgbaString(vc._colorBr));
                } else {
                    gradient.addColorStop(0, StageUtils$1.getRgbString(vc._colorUl));
                    gradient.addColorStop(1, StageUtils$1.getRgbString(vc._colorBr));
                }
            }
        }
        ...
        if (gradient) {
            ...
            ctx.fillStyle = transparency ? StageUtils$1.getRgbaString(color) : StageUtils$1.getRgbString(color);
        }
    }
...
class Utils$2 {
    ...
    static getArrayIndex(index, arr) {
        return Utils$2.getModuloIndex(index, arr.length);
    }

    static equalValues(v1, v2) {
        if ((typeof v1) !== (typeof v2)) return false
        if (Utils$2.isObjectLiteral(v1)) {
            return Utils$2.isObjectLiteral(v2) && Utils$2.equalObjectLiterals(v1, v2)
        } else if (Array.isArray(v1)) {
            return Array.isArray(v2) && Utils$2.equalArrays(v1, v2)
        } else {
            return v1 === v2
        }
    }
...
class WebGLState {
    ...
    setSetting(func, v) {
        ...
        const change = !s || !Utils$2.equalValues(s, v);
    ...
    setPixelStorei(pname, param) {
        ...
        const change = !Utils$2.equalValues(this._pixelStorei[i], param);
    ...
    _migrateSettings(t, s) {
        ...
        s._settings.forEach((value, func) => {
            ...
            if (!tValue || !Utils$2.equalValues(tValue, value)) {
...
class TransitionSettings {
    constructor(stage) {
        ...
        this._timingFunctionImpl = StageUtils$1.getTimingFunction(this._timingFunction);
        this.delay = 0;
        this.duration = 0.2;
        this.merger = null;
    }
    ...
    set timingFunction(v) {
        ...
        this._timingFunctionImpl = StageUtils$1.getTimingFunction(v);
    }
        ...
        if (factor !== 1) {
            ...
            if (Utils$1.isNumber(v) && Utils$1.isNumber(sv)) {
                if (this.hasColorProperty()) {
                    v = StageUtils$1.mergeColors(v, sv, factor);
                } else {
                    v = StageUtils$1.mergeNumbers(v, sv, factor);
                }
            }
        }
...
class AnimationSettings {
    constructor() {
        ...
        this._stopTimingFunctionImpl = StageUtils$1.getTimingFunction(this._stopTimingFunction);
        this.stopDuration = 0;
        this.stopDelay = 0;
    }
    ...
    set stopTimingFunction(v) {
        ...
        this._stopTimingFunctionImpl = StageUtils$1.getTimingFunction(v);
    }
...
class Stage extends EventEmitter {
    ...
    setClearColor(clearColor) {
        ...
        if (clearColor === null) {
            ...
            this._clearColor = StageUtils$1.getRgbaComponentsNormalized(clearColor);
        }
    }
...
class OutlineShader extends DefaultShader {
    ...
    set color(v) {
        if (this._col !== v) {
            const col = StageUtils$1.getRgbaComponentsNormalized(v);
            col[0] = col[0] * col[3];
            col[1] = col[1] * col[3];
            col[2] = col[2] * col[3];
