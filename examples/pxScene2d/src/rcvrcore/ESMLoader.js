...
function ESMLoader(params) {
  ...
  this.loadESM = function(filename) {
    ...
    const script = new vm.Script("var sgl = require('webgl.js'); global.sparkwebgl = sparkwebgl = new sgl.WebGLRenderingContext(global.sparkscene); global.sparkgles2 = sparkgles2 = require('gles2.js');");
