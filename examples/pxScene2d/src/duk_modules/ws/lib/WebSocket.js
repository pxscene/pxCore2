...
Object.defineProperty(WebSocket.prototype, 'bufferedAmount', {
  get: function get() {
    ...
    if (this._socket) {
      // TODO
      amount = 0; //this._socket.bufferSize || 0;
    }
    return amount;
  }
});
...
function initAsClient(address, protocols, options) {
  ...
  var requestOptions = {
    ...
    url: (isSecure ? 'https://' : 'http://') + serverUrl.hostname + ':' + port + (serverUrl.path || '/'),
    headers: {
      'Connection': 'Upgrade',
      'Upgrade': 'websocket',
      'Host': headerHost,
  ...
  req.on('upgrade', function upgrade(headers, socket) {
    ...
    var serverKey = headers['sec-websocket-accept'];
    if (typeof serverKey === 'undefined' || serverKey !== expectedServerKey) {
      //print("serverKey=" + serverKey);
      //print("expected=" + expectedServerKey);
    ...
    var serverProt = headers['sec-websocket-protocol'];
    ...
    var serverExtensions = Extensions.parse(headers['sec-websocket-extensions']);
