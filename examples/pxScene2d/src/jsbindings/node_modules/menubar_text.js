...
var MenuBarImage = require("menubar_image");
...
// Images are typically 350x197
var childImages = [];
// TV
childImages[0] =  [ globals.gUrlStart+"ChicagoFire.jpg", 
					globals.gUrlStart+"Constantine.jpg",
					globals.gUrlStart+"Blacklist.jpg",
					globals.gUrlStart+"CelebrityApprentice.jpg",
					globals.gUrlStart+"BurnNotice.jpg",
					globals.gUrlStart+"Grimm.jpg",
					globals.gUrlStart+"Mentalist.jpg"];
// Movies
childImages[1] =  [ globals.gUrlStart+"IronMan.jpg", 
					globals.gUrlStart+"Avengers.jpg",
					globals.gUrlStart+"AmericanHustle.jpg",
					globals.gUrlStart+"Gravity.jpg"];	
// Kids
childImages[2] =  [ globals.gUrlStart+"Frozen.jpg", 
					globals.gUrlStart+"Aladdin.jpg",
					globals.gUrlStart+"LionKing.jpg",
					globals.gUrlStart+"IceAge4.jpg"];		
// Networks
childImages[3] =  [ globals.gUrlStart+"bio.jpg", 
					globals.gUrlStart+"TLC.jpg",
					globals.gUrlStart+"Fox.jpg",
					globals.gUrlStart+"Spike.jpg"];	
// Music
childImages[4] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
					globals.gUrlStart+"FMusic.jpg",
					globals.gUrlStart+"RockOfAgesMusic.jpg",
					globals.gUrlStart+"NewMusicLive.jpg"];
						
// Latino
childImages[5] =  [ globals.gUrlStart+"ChicagoFire.jpg", 
					globals.gUrlStart+"Constantine.jpg",
					globals.gUrlStart+"Blacklist.jpg",
					globals.gUrlStart+"CelebrityApprentice.jpg",
					globals.gUrlStart+"BurnNotice.jpg",
					...
					globals.gUrlStart+"Mentalist.jpg"];
// ?
childImages[6] =  [ globals.gUrlStart+"IronMan.jpg", 
					globals.gUrlStart+"Avengers.jpg",
					globals.gUrlStart+"AmericanHustle.jpg",
					globals.gUrlStart+"Gravity.jpg"];	
// ?
childImages[7] =  [ globals.gUrlStart+"Frozen.jpg", 
					globals.gUrlStart+"Aladdin.jpg",
					globals.gUrlStart+"LionKing.jpg",
					globals.gUrlStart+"IceAge4.jpg"];		
// ?
childImages[8] =  [ globals.gUrlStart+"bio.jpg", 
					globals.gUrlStart+"TLC.jpg",
					globals.gUrlStart+"Fox.jpg",
					globals.gUrlStart+"Spike.jpg"];	
// ?
childImages[9] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
					globals.gUrlStart+"FMusic.jpg",
					globals.gUrlStart+"RockOfAgesMusic.jpg",
					globals.gUrlStart+"NewMusicLive.jpg"];	
// ?
childImages[10] =  [ globals.gUrlStart+"ChicagoFire.jpg", 
					globals.gUrlStart+"Constantine.jpg",
					globals.gUrlStart+"Blacklist.jpg",
					globals.gUrlStart+"CelebrityApprentice.jpg",
					globals.gUrlStart+"BurnNotice.jpg",
					...
					globals.gUrlStart+"Mentalist.jpg"];
// ?
childImages[11] =  [ globals.gUrlStart+"IronMan.jpg", 
					globals.gUrlStart+"Avengers.jpg",
					globals.gUrlStart+"AmericanHustle.jpg",
					globals.gUrlStart+"Gravity.jpg"];	
																	

var childImagesRow3Text = [ "Recent TV Shows", "New and Most Popular", 	
							"Recent Kids Shows", "Networks A-Z", "Recent Music Videos",
							"Recent TV Shows", "New and Most Popular", 	
							"Recent Kids Shows", "Networks A-Z", "Recent Music Videos",
							"Recent TV Shows", "New and Most Popular", 	
							"Recent Kids Shows", "Networks A-Z", "Recent Music Videos"];
var childImagesRow3	= [];		
// TV
childImagesRow3[0] =  [ globals.gUrlStart+"Mentalist_vert.jpg", 
						globals.gUrlStart+"BurnNotice_vert.jpg",
						globals.gUrlStart+"Suits_vert.jpg",
						globals.gUrlStart+"MadMen_vert.jpg"];
// Movies
childImagesRow3[1] =  [ globals.gUrlStart+"Furious.png", 
						globals.gUrlStart+"IronMan2_vert.jpg",
						globals.gUrlStart+"JurassicWorld.jpg",
						globals.gUrlStart+"PitchPerfect2.jpg"];	
// Kids
childImagesRow3[2] =  [ globals.gUrlStart+"Minions.png", 
						globals.gUrlStart+"IceAge_vert.jpg",
						globals.gUrlStart+"LionKing_vert.jpg",
						globals.gUrlStart+"Frozen_vert.jpg"];		
// Networks
childImagesRow3[3] =  [ globals.gUrlStart+"Mentalist_vert.jpg", 
						globals.gUrlStart+"BurnNotice_vert.jpg",
						globals.gUrlStart+"Suits_vert.jpg",
						globals.gUrlStart+"MadMen_vert.jpg"];	
// Music
childImagesRow3[4] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
						globals.gUrlStart+"FMusic.jpg",
						globals.gUrlStart+"RockOfAgesMusic.jpg",
						globals.gUrlStart+"NewMusicLive.jpg"];	
// ?
childImagesRow3[5] =  [ globals.gUrlStart+"Mentalist_vert.jpg", 
						globals.gUrlStart+"BurnNotice_vert.jpg",
						globals.gUrlStart+"Suits_vert.jpg",
						globals.gUrlStart+"MadMen_vert.jpg"];
// ?
childImagesRow3[6] =  [ globals.gUrlStart+"Furious.png", 
						globals.gUrlStart+"IronMan2_vert.jpg",
						globals.gUrlStart+"JurassicWorld.jpg",
						globals.gUrlStart+"PitchPerfect2.jpg"];	
// ?
childImagesRow3[7] =  [ globals.gUrlStart+"Minions.png", 
						globals.gUrlStart+"IceAge_vert.jpg",
						globals.gUrlStart+"LionKing_vert.jpg",
						globals.gUrlStart+"Frozen_vert.jpg"];		
// ?
childImagesRow3[8] =  [ globals.gUrlStart+"Mentalist_vert.jpg", 
						globals.gUrlStart+"BurnNotice_vert.jpg",
						globals.gUrlStart+"Suits_vert.jpg",
						globals.gUrlStart+"MadMen_vert.jpg"];	
// ?
childImagesRow3[9] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
						globals.gUrlStart+"FMusic.jpg",
						globals.gUrlStart+"RockOfAgesMusic.jpg",
						globals.gUrlStart+"NewMusicLive.jpg"];
// ?
childImagesRow3[10] =  [ globals.gUrlStart+"Minions.png", 
						globals.gUrlStart+"IceAge_vert.jpg",
						globals.gUrlStart+"LionKing_vert.jpg",
						globals.gUrlStart+"Frozen_vert.jpg"];		
// ?
childImagesRow3[11] =  [ globals.gUrlStart+"Mentalist_vert.jpg", 
						globals.gUrlStart+"BurnNotice_vert.jpg",
						globals.gUrlStart+"Suits_vert.jpg",
						globals.gUrlStart+"MadMen_vert.jpg"];	
// ?
childImagesRow3[12] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
						globals.gUrlStart+"FMusic.jpg",
						globals.gUrlStart+"RockOfAgesMusic.jpg",
						globals.gUrlStart+"NewMusicLive.jpg"];												

var childImagesRow4Text = [ "More TV Shows", "More Most Popular", 	
							"More Kids Shows", "Networks Extras", "More Recent Music Videos",
							"More TV Shows", "More Most Popular", 	
							"More Kids Shows", "Networks Extras", "More Recent Music Videos",
							"More TV Shows", "More Most Popular", 	
							"More Kids Shows", "Networks Extras", "More Recent Music Videos"];
var childImagesRow4 = [];
// TV
childImagesRow4[0] =  [ globals.gUrlStart+"ChicagoFire.jpg", 
					globals.gUrlStart+"Constantine.jpg",
					globals.gUrlStart+"Blacklist.jpg",
					globals.gUrlStart+"CelebrityApprentice.jpg"];
// Movies
childImagesRow4[1] =  [ globals.gUrlStart+"IronMan.jpg", 
					globals.gUrlStart+"Avengers.jpg",
					globals.gUrlStart+"AmericanHustle.jpg",
					globals.gUrlStart+"Gravity.jpg"];	
// Kids
childImagesRow4[2] =  [ globals.gUrlStart+"Frozen.jpg", 
					globals.gUrlStart+"Aladdin.jpg",
					globals.gUrlStart+"LionKing.jpg",
					globals.gUrlStart+"IceAge4.jpg"];		
// Networks
childImagesRow4[3] =  [ globals.gUrlStart+"bio.jpg", 
					globals.gUrlStart+"TLC.jpg",
					globals.gUrlStart+"Fox.jpg",
					globals.gUrlStart+"Spike.jpg"];	
// Music
childImagesRow4[4] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
					globals.gUrlStart+"FMusic.jpg",
					globals.gUrlStart+"RockOfAgesMusic.jpg",
					globals.gUrlStart+"NewMusicLive.jpg"];																									
// ?
childImagesRow4[5] =  [ globals.gUrlStart+"ChicagoFire.jpg", 
					globals.gUrlStart+"Constantine.jpg",
					globals.gUrlStart+"Blacklist.jpg",
					globals.gUrlStart+"CelebrityApprentice.jpg"];
// ?
childImagesRow4[6] =  [ globals.gUrlStart+"IronMan.jpg", 
					globals.gUrlStart+"Avengers.jpg",
					globals.gUrlStart+"AmericanHustle.jpg",
					globals.gUrlStart+"Gravity.jpg"];	
// ?
childImagesRow4[7] =  [ globals.gUrlStart+"Frozen.jpg", 
					globals.gUrlStart+"Aladdin.jpg",
					globals.gUrlStart+"LionKing.jpg",
					globals.gUrlStart+"IceAge4.jpg"];		
// ?
childImagesRow4[8] =  [ globals.gUrlStart+"bio.jpg", 
					globals.gUrlStart+"TLC.jpg",
					globals.gUrlStart+"Fox.jpg",
					globals.gUrlStart+"Spike.jpg"];	
// ?
childImagesRow4[9] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
					globals.gUrlStart+"FMusic.jpg",
					globals.gUrlStart+"RockOfAgesMusic.jpg",
					globals.gUrlStart+"NewMusicLive.jpg"];
// ?
childImagesRow4[10] =  [ globals.gUrlStart+"Frozen.jpg", 
					globals.gUrlStart+"Aladdin.jpg",
					globals.gUrlStart+"LionKing.jpg",
					globals.gUrlStart+"IceAge4.jpg"];		
// ?
childImagesRow4[11] =  [ globals.gUrlStart+"bio.jpg", 
					globals.gUrlStart+"TLC.jpg",
					globals.gUrlStart+"Fox.jpg",
					globals.gUrlStart+"Spike.jpg"];	
// ?
childImagesRow4[12] =  [ globals.gUrlStart+"TaylorSwift.jpg", 
					globals.gUrlStart+"FMusic.jpg",
					globals.gUrlStart+"RockOfAgesMusic.jpg",
					globals.gUrlStart+"NewMusicLive.jpg"];

function MenuBarText(parentScene, name, x, y, w, h, textItems) {
	this.name = name;
	...
	this.container.on('onKeyDown', function(e) {
		...
		if( e.keyCode == 39 || e.keyCode == 37) {
			...
			this.textObjs[this.focusIndx].textColor = this.idleColor;
			  ...
			  this.menuBarImage.setMenuItems("Featured "+this.textItems[this.focusIndx], childImages[this.focusIndx]);
			  this.menuBarImage2.setMenuItems(childImagesRow3Text[this.focusIndx], childImagesRow3[this.focusIndx]);
			  this.menuBarImage3.setMenuItems(childImagesRow4Text[this.focusIndx], childImagesRow4[this.focusIndx]);
		} 
...
MenuBarText.prototype.showMenu = function(x, y) {
	...
	this.menuBarImage = new MenuBarImage(this.container, "imageMenuBar", 25, 135, 1255, 600, childImages[0]);
	this.menuBarImage.picWidth = 350;
	this.menuBarImage.picHeight = 197;
	this.menuBarImage.showMenu();
	
	// Vertical image bar
	this.menuBarImage2 = new MenuBarImage(this.container, "imageMenuBar2", 25, 500, 1255,600, childImagesRow3[0]);
	...
	this.menuBarImage3 = new MenuBarImage(this.container, "imageMenuBar3", 25, 865, 1255, 600, childImagesRow4[0]);
	...
	for( var i = 0; i < this.textItems.length; i++){
		var t = scene.createText({text:this.textItems[i],
