...
o.animateToF({r:360},2,scene.PX_LINEAR,scene.PX_LOOP);
o.animateToF({sx:0.5,sy:0.5,a:0},2,scene.PX_LINEAR,scene.PX_SEESAW);
o.children[1].animateToF({r:-360},1,scene.PX_LINEAR,scene.PX_LOOP);
