...
var rect = scene.create({t:"rect", parent:root, w:400, h:400, lineColor:0xFF0000FF, lineWidth:1, clip:true});
var container = scene.create({t:"object", parent:root, w:400, h:400, clip:true});

// widgets for tracking current property settings
var truncationStatus = scene.create({t:"text", parent:root, x:20, y:420, textColor:0xFFDDFFFF, pixelSize:20,text:"truncation=truncate"});
var wrapStatus = scene.create({t:"text", parent:root, x:20, y:440, textColor:0xFFDDFFFF, pixelSize:20,text:"wordWrap=true"});
var hAlignStatus = scene.create({t:"text", parent:root, x:20, y:460, textColor:0xFFDDFFFF, pixelSize:20,text:"hAlign=left"});
var vAlignStatus = scene.create({t:"text", parent:root, x:20, y:480, textColor:0xFFDDFFFF, pixelSize:20,text:"vAlign=top"});
var ellipsisStatus = scene.create({t:"text", parent:root, x:20, y:500, textColor:0xFFDDFFFF, pixelSize:20,text:"ellipsis=true"});
var px = 0;
var py = 0;
var leading = 0;
...
var text2 = scene.create({t:"text2", clip:true, parent:container, x:px, y:py, rx:0, ry:1, rz:0});
   text2.h=400;
   text2.w=400;
