...
var rect = scene.create({t:"rect", parent:root, w:400, h:400, lineColor:0xFF0000FF, lineWidth:1, clip:false});
...
var text2 = scene.create({t:"textBox",   text:longText,  fontUrl:"DancingScript-Bold.ttf", alignVerticalHorizontal:1, alignVertical:0, xStartPos:25,xStopPos:0,
