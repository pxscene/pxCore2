...
var font = scene.create({t:"fontResource",url:"http://54.146.54.142/tom/receiverdotjs/fonts/XFINITYSansTT-New-Lgt.ttf"});
...
var text2 = scene.create({t:"textBox", clip:true, parent:root, x:200, y:150,
...
var myImage = scene.create({t:"image",url:url,parent:rect,w:200,h:200,autoSize:false,clip:true,stretchX:scene.stretch.STRETCH,stretchY:scene.stretch.STRETCH});
...
// This works if load.js is updating the FPS text output on screen, but not if it's not. 
// Doesn't seem to respect the passed in w/h; instead, must be set in promise!
var myImage = scene.create({t:"image9",url:url,parent:rect,y:200,x:200,w:200,h:200,autoSize:false,clip:true,
