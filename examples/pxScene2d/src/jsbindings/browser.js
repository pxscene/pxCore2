...
var root = scene.root;
var bg = scene.create({t:"image",url:"./status_bg.png",parent:root,xStretch:1,yStretch:1});
var inputbg = scene.create({t:"image9",a:0.9,url:"./input2.png",x:10,y:10,w:400,lInset:10,rInset:10,tInset:10,bInset:10,parent:bg});
