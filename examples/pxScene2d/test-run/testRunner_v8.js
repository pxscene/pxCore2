...
var runTests = function( i) {  
  ...
  if( i < numUrls) {
      ...
      var enableScreenshot = (undefined != testUrls[i].screenshot)?testUrls[i].screenshot:enableScreenshotParam;
      if (undefined != enableScreenshot)
      {
        screenShotString = "&enableScreenshot=" + enableScreenshot;
      }
      
      var test  = scene.create({t:'scene',parent:root,url:url+manualString+screenShotString,x:0, y:0, w:scene.w, h:scene.h});
