...
.then(imports => {
  ...
  module.exports.http_request = url => {
    return new Promise((resolve, reject) => {
      let req = http2.request(url, resolve);
  ...
  module.exports.tests = {
    ...
    byDefaultArbitraryAppCanAccessGoogle: () => {
      return new Promise(resolve => {
        let appLink = "https://tinyurl.com/y9ez78pa?module=http2&url=https://www.google.com/";
        // -> https://px-apps.sys.comcast.net/pxscene-samples/examples/px-reference/tests/test_access_url.js?module=http2&url=https://www.google.com/
        let new_scene = scene.create({
    ...
    byDefaultArbitraryAppCanNotAccessLocalhost: () => {
      return new Promise(resolve => {
        let appLink = "https://tinyurl.com/y9ez78pa?module=http2&url=https://127.0.0.1/";
        // -> https://px-apps.sys.comcast.net/pxscene-samples/examples/px-reference/tests/test_access_url.js?module=http2&url=https://127.0.0.1/
        let new_scene = scene.create({
          t: 'scene', parent: scene.root, w: scene.w, h: scene.h, url: appLink
        });
        new_scene.ready.then(s => {
