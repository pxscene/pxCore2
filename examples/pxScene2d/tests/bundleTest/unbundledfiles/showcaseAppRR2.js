...
////////////////////////////////
      ...
      var shadowUrl = px.getPackageBaseFilePath() + "/images/BlurRect.png";
      var insets = { insetTop: 48, insetBottom: 48, insetLeft: 48, insetRight: 48 };
      let shadow = scene.create( Object.assign(insets, {t:"image9", x:-20, y:-20, w:frameW+ 45, h:frameH+50, url:shadowUrl, interactive: false,  parent: frame, a: 0.95}) );
...
//        imgUrl = imgUrl.replace("https", "http");
  ...
  function doBlur(o)
  {
    ...
    shadowBlurAnim = shadow.animate({ sx: 1.0, sy: 1.0, a: 0.15 },   TT, EASING, FFWD, 1);
