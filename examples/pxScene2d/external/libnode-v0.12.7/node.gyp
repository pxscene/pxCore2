{
  ...
  'targets': [
    {
      'target_name': 'node',
      'type': '<(node_target_type)', #'shared_library', #  'executable',
      ...
      'conditions': [
        ...
        [ 'node_use_openssl=="true"', {
          ...
          'conditions': [
            [ 'node_shared_openssl=="false"', {
              ...
              'conditions': [
                ['OS in "linux freebsd" and node_target_type=="executable"', { #666
                  'ldflags': [
        ...
        [
          'OS in "linux freebsd" and node_shared_v8=="false" and node_target_type=="executable"', {  #666
            'ldflags': [
