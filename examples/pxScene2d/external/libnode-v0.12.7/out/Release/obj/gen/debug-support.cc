...
int v8dbg_fieldindex_mask = PropertyDetails::FieldIndexField::kMask;
int v8dbg_fieldindex_shift = PropertyDetails::FieldIndexField::kShift;
...
int v8dbg_class_SharedFunctionInfo__feedback_vector__FixedArray = SharedFunctionInfo::kFeedbackVectorOffset;
