...
REM ---------- GIF
REM if EXIST vc.build\builds (
REM   copy /y vc.build\builds\libgif.lib giflib-5.1.9\libgif.lib
REM  copy /y vc.build\builds\libgif.lib giflib-5.1.9\libgif.7.lib
REM )
