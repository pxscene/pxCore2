function PXShapeItemElement(data,dynamicProperties,globalData){
    this.lcEnum = {
        '1': 'butt',
        '2': 'round',
        '3': 'butt'
...
PXShapeItemElement.prototype.dashResetter = [];

PXShapeItemElement.prototype.searchShapes = function(arr,data,dynamicProperties,addedTrims){
...
PXShapeItemElement.prototype.renderShape = function(parentTransform,items,data,isMain){
    var i, len;
    if(!items){
        items = this.data;
...
PXShapeItemElement.prototype.renderPath = function(pathData,viewData,groupTransform){
    var len, i;
...
PXShapeItemElement.prototype.renderFill = function(styleData,viewData, groupTransform){
...
PXShapeItemElement.prototype.renderStroke = function(styleData,viewData, groupTransform){
    var styleElem = viewData.style;
    //TODO fix dashes
    var d = viewData.d;
...
PXShapeItemElement.prototype.destroy = function(){
    this.data = null;
