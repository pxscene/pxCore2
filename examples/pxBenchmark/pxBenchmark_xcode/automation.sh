...
ARRISXI6_DN=${array[26]}
ARRISXI6_FIRMWARE=${array[29]}
ARRISXI6_DATE=${array[30]}
ARRISXI6_CPU=${array[31]}
ARRISXI6_GPU=${array[32]}
ARRISXI6_NOTES=${array[33]}
echo "$ARRISXI6_DN $ARRISXI6_FIRMWARE $ARRISXI6_DATE $ARRISXI6_CPU $ARRISXI6_GPU $ARRISXI6_NOTES"


ARRISXG1V4_DN=${array[35]}
ARRISXG1V4_FIRMWARE=${array[36]}
ARRISXG1V4_DATE=${array[37]}
ARRISXG1V4_CPU=${array[38]}
ARRISXG1V4_GPU=${array[39]}
