 ...
 * @returns {string} the node buffer
 */
function toString(messageObj) {
  return JSONbig.stringify(messageObj);
}
 ...
 * @param messageString {String} the message buffer
 * @returns {Object} the message object
 */
function fromString(messageString) {
  const messageObj = JSONbig.parse(messageString);
