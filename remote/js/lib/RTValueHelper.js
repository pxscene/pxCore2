...
/**
 * create a new rtValue, not that this rtvalue can a json object directly
...
function create(value, type) {
  ...
  switch (type) {
    case RTValueType.FUNCTION: {
      // create rtValue with type function
    ...
    case RTValueType.UINT64: {
      if (typeof value !== 'object') {
        throw new Error(`INT64/UINT64 cannot initialize with type ${typeof value}, only can use BigNumber initialize`);
      }
      break;
    }
    default:
