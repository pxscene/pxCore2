...
public enum SparkStatusCode {
  ...
  SparkStatusCode(int code) {
    m_code = code;
  }

  public static SparkStatusCode fromInt(int n) {
    for (SparkStatusCode code : SparkStatusCode.values()) {
      if (code.getCode() == n)
        return code;
    }
    return SparkStatusCode.UNKNOWN;
  }
